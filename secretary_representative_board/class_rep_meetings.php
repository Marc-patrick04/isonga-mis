...
try {
    ...
    // Check if meeting_minutes table exists for pending minutes count
    $pending_minutes = 0;
    try {
        $stmt = $pdo->query("SHOW TABLES LIKE 'meeting_minutes'");
        if ($stmt->rowCount() > 0) {
            $stmt = $pdo->query("SELECT COUNT(*) as pending_minutes FROM meeting_minutes WHERE status = 'draft'");
...
<head>
    ...
    <style>
        /* Your existing CSS styles remain exactly the same as the President's version */
        :root {
            --primary-blue: #007bff;
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div style="display: grid; gap: 0.75rem;">
                                ...
                                <a href="meeting_minutes.php" class="btn btn-info" style="background: var(--info);">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div style="display: grid; gap: 1rem;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Upcoming</span>
                                    <strong style="color: var(--text-dark);"><?php echo $upcoming_meetings; ?></strong>
                                </div>
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Completed</span>
                                    <strong style="color: var(--text-dark);"><?php echo $completed_meetings; ?></strong>
                                </div>
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Cancelled</span>

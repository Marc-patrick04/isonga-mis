...
try {
    ...
    $pdf->SetTitle('Public Relations Budget Approval Letter');
    ...
    $pdf->Cell(0, 10, 'PUBLIC RELATIONS BUDGET PROGRAM', 0, 1, 'C');
    $pdf->SetFont('helvetica', 'B', 16);
    ...
    // Introduction
    $intro = "I, " . $request['requester_name'] . ", serving as Minister of Public Relations at RP Musanze College, hereby strongly prove that I requested a budget of RWF " . 
    ...
    $purpose = "This letter serves as official evidence and reference for the public relations budget approved to support: " . 
        $request['purpose'] . ". The funds will be utilized for public relations activities, communications, media engagement, and promotional activities as stated in the application.\n\n";
    ...
    $pdf->Cell(0, 10, 'GUIDELINES FOR PUBLIC RELATIONS BUDGET UTILIZATION:', 0, 1, 'L', true);
    $pdf->Ln(3);

    $pdf->SetFont('helvetica', '', 11);
    $guidelines = "1. The approved amount MUST be used exclusively for: " . $request['purpose'] . "\n" .
        "2. Funds allocated for media outreach, communications, promotional materials, and public relations events\n" .
        "3. Keep all original receipts, invoices, and media purchase orders for verification\n" .
        ...
        "8. Submit a detailed expenditure report with media coverage evidence within 30 days\n" .
        "9. This approval is non-transferable to any other committee or purpose\n" .
        "10. Maintain proper financial and media relations records for audit purposes\n\n";
    ...
    $disbursement = "To receive the approved public relations budget, you MUST present this printed letter at the Guild Council Office along with:\n\n" .
        "✓ Original Student ID Card\n" .
        "✓ Printed copy of this approval letter\n" .
        "✓ Completed disbursement form (available at the office)\n" .
        "✓ Detailed public relations implementation plan\n" .
        "✓ Media engagement schedule (if applicable)\n\n" .
    ...
    $agreement = "I hereby declare that I have read and understood all the terms and conditions stated above. " .
        "I agree to use the approved public relations budget responsibly for media outreach, communications, " .
        "and promotional activities as specified. I acknowledge that any violation of these terms may result " .
    ...
    <tr>
        ...
        <td width="50%" class="signature-cell">
            ...
            <div style="margin-bottom: 8px; font-size: 11px;">
                Position: Minister of Public Relations
            </div>
            <div style="margin-bottom: 8px; font-size: 11px;">
    ...
    $pdf->SetTextColor(128, 128, 128); // Gray color
    $pdf->MultiCell(0, 8, 
        "Note: This document serves as official approval for public relations budget disbursement. " .
    ...
    // Output PDF
    $filename = 'Public_Relations_Budget_Approval_' . ($request['requester_reg'] ?: 'Minister_PR') . '_' . date('Ymd') . '.pdf';

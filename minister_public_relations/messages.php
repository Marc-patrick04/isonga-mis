...
// Check if user is logged in and is  Public Relations & Association
...
<head>
    ...
    <title>Messages - Minister of Public Relations & Association - Isonga RPSU</title>
        ...
        <div class="nav-container">
            <div class="logo-section">
                ...
                <div class="brand-text">
                    <h1>Isonga - Minister of PR & Association</h1>
                </div>
            </div>
            <div class="user-menu">
                ...
                <div class="user-info">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-role">Minister of Public Relations & Association</div>
                    </div>
                </div>

...
try {
    ...
    $recent_docs = $stmt->fetch(PDO::FETCH_ASSOC)['recent_docs'];
        ...
        <main class="main-content">
            ...
            <div class="stats-grid" style="margin-top: 1rem;">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-number"><?php echo $recent_notes; ?></div>
                ...
                <div class="stat-card success">
                    ...
                    <div class="stat-content">
                        <div class="stat-number"><?php echo $recent_docs; ?></div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php if (empty($recent_cases)): ?>
                                        <tr>
                                            <td colspan="5" style="text-align: center; color: var(--dark-gray); padding: 2rem;">No cases found</td>
                                        </tr>
                                    <?php else: ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div style="display: grid; gap: 1rem;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Active Elections</span>
                                    <strong style="color: var(--text-dark);"><?php echo $active_elections; ?></strong>
                                </div>
                            </div>
                        </div>
                    </div>

...
<head>
    ...
    <title>View Budget Request - Minister of Health - Isonga RPSU</title>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="page-title">
                <h1>Health Budget Request #<?php echo $request['id']; ?></h1>
                <p>View detailed information about your health funding request</p>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="info-grid">
                    ...
                    <div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">Minister of Health</div>
                        </div>
                        <div class="info-group">
                ...
                <div class="info-group">
                    <div class="info-label">Health Action Plan Document</div>
                    <a href="../<?php echo $request['action_plan_file_path']; ?>" class="file-download" target="_blank">
                        <div class="file-icon">
                            <i class="fas fa-file-pdf"></i>
                        </div>
                        <div class="file-info">
                            <div class="file-name">Download Health Action Plan</div>
            ...
            <div class="card-body">
                <div class="timeline">
                    ...
                    <div class="timeline-item completed">
                        ...
                        <div class="timeline-content">Health budget request was submitted for review</div>
                    </div>
                    ...
                    <div class="timeline-item <?php echo $request['status'] === 'funded' ? 'completed' : 'pending'; ?>">
                        ...
                        <div class="timeline-content">
                            <?php if ($request['status'] === 'funded'): ?>
                                Funds have been disbursed for health initiatives
                            <?php else: ?>
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ol style="margin: 0.5rem 0 0 1rem;">
                        ...
                        <li>Print the letter and get physical signatures from both Minister of Health and Vice Guild Finance</li>

            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-role">Minister of Health</div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="profile-tab" class="tab-pane <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                                <form method="POST" id="profileForm">
                                    ...
                                    <div class="form-section">
                                        <h4>Health Portfolio Information</h4>
                                        <div class="form-group">
                                            <label for="bio">Bio & Health Initiatives</label>
                                            <textarea id="bio" name="bio" class="form-control" 
                                                      placeholder="Tell us about your health initiatives and student welfare programs..."><?php echo htmlspecialchars($user['bio'] ?? ''); ?></textarea>
                                        </div>
                                ...
                                <form method="POST" id="preferencesForm">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive health alerts and notifications via email</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive urgent health alerts via SMS</small>
                                        </div>
                                    </div>

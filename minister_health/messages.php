...
try {
    ...
    $stmt->execute();
    $health_tickets = $stmt->fetch(PDO::FETCH_ASSOC)['health_tickets'];
    ...
    $stmt->execute();
    $pending_hostel = $stmt->fetch(PDO::FETCH_ASSOC)['pending_hostel'];

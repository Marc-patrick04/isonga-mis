    ...
    <div class="dashboard-container">
        ...
        <main class="main-content" id="mainContent">
                        ...
                        <div class="filters-card">
                            <form method="GET" class="filter-form" id="filterForm">
                                ...
                                <div class="filter-actions">
                                    ...
                                    <a href="hostels.php?tab=overview" class="btn btn-outline">
            ...
            <div id="rooms" class="tab-content <?php echo $tab === 'rooms' ? 'active' : ''; ?>">
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fas fa-door-open"></i> Rooms Management</h3>
                        <div class="card-header-actions">
            ...
            <div id="allocations" class="tab-content <?php echo $tab === 'allocations' ? 'active' : ''; ?>">
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fas fa-user-check"></i> Student Allocations</h3>
                        <div class="card-header-actions">
            ...
            <div id="allocation" class="tab-content <?php echo $tab === 'allocation' ? 'active' : ''; ?>">
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fas fa-user-plus"></i> Allocate Student to Hostel</h3>
                    </div>
                    <div class="card-body">

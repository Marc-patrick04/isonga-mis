...
// Get dashboard statistics for sidebar (advisor-specific)
try {
...
<head>
    ...
    <title>Profile & Settings - Arbitration Advisor - Isonga RPSU</title>
            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-role">Arbitration Advisor</div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="profile-tab" class="tab-pane <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                                <form method="POST" id="profileForm">
                                    ...
                                    <div class="form-section">
                                        <h4>Arbitration Advisor Information</h4>
                                        <div class="form-group">
                                            <label for="bio">Bio & Arbitration Philosophy</label>
                                            <textarea id="bio" name="bio" class="form-control" 
                                                      placeholder="Describe your approach to conflict resolution and arbitration guidance..."><?php echo htmlspecialchars($user['bio'] ?? ''); ?></textarea>
                                        </div>
                                ...
                                <form method="POST" id="preferencesForm">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive case updates and hearing notifications via email</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive urgent arbitration alerts via SMS</small>
                                        </div>
                                    </div>

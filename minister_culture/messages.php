...
try {
    ...
    $stmt->execute();
    $culture_tickets = $stmt->fetch(PDO::FETCH_ASSOC)['culture_tickets'];
    ...
    $stmt->execute();
    $cultural_clubs = $stmt->fetch(PDO::FETCH_ASSOC)['cultural_clubs'];
    ...
    $stmt->execute();
    $cultural_tickets = $stmt->fetch(PDO::FETCH_ASSOC)['cultural_tickets'];
    ...
    <div id="newConversationModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>New Cultural Conversation</h3>

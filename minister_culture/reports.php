...
// Get available templates for Minister of Culture
try {
    $stmt = $pdo->prepare("
            ...
            'fields' => json_encode([
                'sections' => [
                    [
                        ...
                        'title' => 'Festival Name',
                        'required' => true,
                        'description' => 'Name of the cultural festival or celebration'
                    ],
                    [
                        'type' => 'date',
                        'title' => 'Festival Date',
                        'required' => true,
                        'description' => 'Date when the festival took place'
                    ],
                    [
                        'type' => 'text',
                        'title' => 'Festival Location',
                        'required' => true,
                        'description' => 'Venue where the festival was held'
                    ],
                    [
                        'type' => 'number',
                        'title' => 'Participant Count',
                        'required' => true,
                        'description' => 'Total number of participants and attendees'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Festival Objectives',
                        'required' => true,
                        'description' => 'Main objectives of the cultural festival'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Cultural Activities',
                        'required' => true,
                        'description' => 'Detailed description of cultural activities performed'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Cultural Groups Involved',
                        'required' => true,
                        'description' => 'List of cultural groups and clubs that participated'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Traditional Elements',
                        'required' => true,
                        'description' => 'Traditional dances, music, and cultural elements showcased'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Achievements',
                        'required' => true,
                        'description' => 'Key achievements and successes from the festival'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Challenges Faced',
                        'required' => false,
                        'description' => 'Any challenges encountered during the festival'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Participant Feedback',
                        'required' => false,
                        'description' => 'Feedback received from participants and attendees'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Recommendations',
                        'required' => true,
                        'description' => 'Suggestions for future cultural festivals'
                    ]
                ]
            ])
        ],
        [
            ...
            'fields' => json_encode([
                'sections' => [
                    [
                        'type' => 'textarea',
                        'title' => 'Cultural Activities Completed',
                        'required' => true,
                        'description' => 'List all cultural activities completed during the month'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Club Activities',
                        'required' => true,
                        'description' => 'Summary of cultural club activities and meetings'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Student Participation',
                        'required' => true,
                        'description' => 'Level and diversity of student participation'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Cultural Competitions',
                        'required' => true,
                        'description' => 'Cultural competitions organized and results'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Traditional Arts Promotion',
                        'required' => true,
                        'description' => 'Efforts to promote traditional Rwandan arts'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Civic Education Activities',
                        'required' => true,
                        'description' => 'Civic education and awareness activities'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Challenges Faced',
                        'required' => false,
                        'description' => 'Cultural and civic education challenges'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Next Month Plans',
                        'required' => true,
                        'description' => 'Planned cultural activities for the coming month'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Budget Utilization',
                        'required' => false,
                        'description' => 'How the cultural budget was utilized'
                    ]
                ]
            ])
        ],
            ...
            'fields' => json_encode([
                'sections' => [
                    [
                        ...
                        'title' => 'Club Name',
                        'required' => true,
                        'description' => 'Name of the cultural club visited'
                    ],
                    [
                        'type' => 'date',
                        'title' => 'Visit Date',
                        'required' => true,
                        'description' => 'Date of the club visit'
                    ],
                    [
                        'type' => 'number',
                        'title' => 'Members Present',
                        'required' => true,
                        'description' => 'Number of club members present during visit'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Activities Observed',
                        'required' => true,
                        'description' => 'Detailed description of activities observed'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Student Engagement',
                        'required' => true,
                        'description' => 'Level and quality of student engagement'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Cultural Skills Development',
                        'required' => true,
                        'description' => 'Cultural skills being developed by members'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Club Achievements',
                        'required' => true,
                        'description' => 'Notable achievements and successes of the club'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Areas for Improvement',
                        'required' => true,
                        'description' => 'Suggestions for club improvement and development'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Support Required',
                        'required' => false,
                        'description' => 'Any support needed from student union'
                    ]
                ]
            ])
        ],
            ...
            'fields' => json_encode([
                'sections' => [
                    [
                        ...
                        'required' => true,
                        'description' => 'Name or title of the performance'
                    ],
                    [
                        'type' => 'date',
                    ...
                    [
                        ...
                        'required' => true,
                        'description' => 'Location where performance took place'
                    ],
                    [
                        'type' => 'number',
                        'title' => 'Audience Size',
                    ...
                    [
                        ...
                        'required' => true,
                        'description' => 'Detailed description of the performance'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Cultural Elements',
                        'required' => true,
                        'description' => 'Traditional cultural elements featured'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Troupe Members',
                        'required' => true,
                        'description' => 'List of troupe members who performed'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Rehearsal Details',
                        'required' => true,
                        'description' => 'Rehearsal schedule and preparation'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Audience Response',
                        'required' => false,
                        'description' => 'Feedback and response from audience'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Challenges',
                        'required' => false,
                        'description' => 'Challenges faced during preparation or performance'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Future Plans',
                        'required' => true,
                        'description' => 'Plans for future performances and improvements'
                    ]
                ]
            ])
        ],
            ...
            'fields' => json_encode([
                'sections' => [
                    [
                        ...
                        'title' => 'Program Title',
                        'required' => true,
                        'description' => 'Name of the civic education program'
                    ],
                    [
                        'type' => 'date',
                        'title' => 'Program Date',
                        'required' => true,
                        'description' => 'Date when program was conducted'
                    ],
                    [
                        'type' => 'text',
                        'title' => 'Target Audience',
                        'required' => true,
                        'description' => 'Student groups targeted by the program'
                    ],
                    [
                        'type' => 'number',
                    ...
                    [
                        ...
                        'required' => true,
                        'description' => 'Main objectives of the civic education program'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Topics Covered',
                        'required' => true,
                        'description' => 'Civic education topics and themes addressed'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Teaching Methods',
                        'required' => true,
                        'description' => 'Methods used to deliver civic education'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Student Engagement',
                        'required' => true,
                        'description' => 'Level of student participation and interest'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Impact Assessment',
                        'required' => true,
                        'description' => 'Assessment of program impact on students'
                    ],
                    [
                        'type' => 'textarea',
                        'title' => 'Follow-up Activities',
                        'required' => false,
                        'description' => 'Planned follow-up and reinforcement activities'
                    ]
                ]
            ])
        ]
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if (empty($submitted_reports)): ?>
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle"></i> No cultural reports submitted yet.
                            </div>
                        <?php else: ?>

...
try {
    ...
    ");
    $stmt->execute([$user_id]);
    $vp_chaired_meetings_list = $stmt->fetchAll(PDO::FETCH_ASSOC);
    
} catch (PDOException $e) {
    error_log("Statistics error: " . $e->getMessage());
    $total_meetings = $upcoming_meetings = $todays_meetings = $vp_chaired_count = 0;
    $attendance_rate = 0;
    $attendance_stats = ['total_invited' => 0, 'attended' => 0, 'absent' => 0, 'excused' => 0];
    $meeting_types = [];
    $upcoming_important = [];
        ...
        <main class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card info">
                    ...
                    <div class="stat-content">
                        <div class="stat-number"><?php echo $vp_chaired_count; ?></div>
                        <div class="stat-label">Meetings Chaired</div>
                    </div>
                </div>

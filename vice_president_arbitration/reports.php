...
// Get available templates for Vice President Arbitration
try {
    $stmt = $pdo->prepare("
...
try {
    $vice_president_templates = [
        [
            'name' => 'Monthly Vice President Arbitration Report',
            'description' => 'Monthly report covering case management, hearing coordination, and support activities',
            'role_specific' => 'vice_president_arbitration',
            'report_type' => 'monthly',
            'fields' => json_encode([
                'sections' => [
                    [
    ...
    foreach ($vice_president_templates as $template_data) {
        $check_stmt = $pdo->prepare("SELECT id FROM report_templates WHERE name = ? AND role_specific = 'vice_president_arbitration'");
...
<head>
    ...
    <title>Arbitration Vice President Reports - Isonga RPSU</title>
                        ...
                        <div class="team-section-editor">
                            ...
                            <form method="POST" action="reports.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-text">
                                        This content will be included in the team report. Please provide comprehensive information about your assigned area.
                                    </div>
                                </div>

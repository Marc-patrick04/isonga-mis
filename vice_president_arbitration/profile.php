...
try {
    ...
    // Mediation cases
    $stmt = $pdo->query("SELECT COUNT(*) as mediation_cases FROM arbitration_cases WHERE status = 'mediation'");
    $mediation_cases = $stmt->fetch(PDO::FETCH_ASSOC)['mediation_cases'] ?? 0;
    ...
    $my_cases = $pending_review = $upcoming_hearings = $mediation_cases = $unread_messages = 0;
...
<head>
    ...
    <title>Profile & Settings - Vice President Arbitration - Isonga RPSU</title>
        ...
        <div class="nav-container">
            <div class="logo-section">
                ...
                <div class="brand-text">
                    <h1>Isonga - Vice President Arbitration</h1>
                </div>
            </div>
            <div class="user-menu">
                ...
                <div class="user-info">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-role">Vice President Arbitration</div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-role">Vice President Arbitration</div>
                        
                        <div class="profile-stats">
                            <div class="stat-item">
                                <div class="stat-number"><?php echo $my_cases; ?></div>
                                <div class="stat-label">My Cases</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-number"><?php echo $mediation_cases; ?></div>
                                <div class="stat-label">Mediation</div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="profile-tab" class="tab-pane <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                                <form method="POST" id="profileForm">
                                    ...
                                    <div class="form-section">
                                        <h4>Arbitration Committee Information</h4>
                                        <div class="form-group">
                                            <label for="bio">Bio & Arbitration Philosophy</label>
                                            <textarea id="bio" name="bio" class="form-control" 
                                                      placeholder="Describe your approach to conflict resolution and mediation..."><?php echo htmlspecialchars($user['bio'] ?? ''); ?></textarea>
                                            <small class="form-hint">Focus on your mediation and case review expertise</small>
                                        </div>
                                ...
                                <form method="POST" id="preferencesForm">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive case updates, hearing notifications, and mediation requests via email</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive urgent arbitration alerts and mediation requests via SMS</small>
                                        </div>
                                    </div>

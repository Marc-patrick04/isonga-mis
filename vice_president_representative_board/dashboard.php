        ...
        <main class="main-content">
            <div class="dashboard-header">
                <div class="welcome-section">
                    ...
                    <p>Assist in overseeing class representatives and monitor student welfare for <?php echo date('Y'); ?> academic year</p>
                </div>
            </div>
            ...
            <div class="content-grid">
                ...
                <div class="right-column">
                    ...
                    <!-- Vice Presidential Authority Reminder -->
                    <div class="alert alert-info">
                        <i class="fas fa-user-tie"></i> 
                        <strong>Vice Presidential Authority:</strong>
                        <ul style="margin: 0.5rem 0 0 1rem; font-size: 0.8rem;">
                            <li>Act on behalf of the President when absent</li>
                            <li>Review and approve class representative reports</li>
                            <li>Assist in overseeing class representative activities</li>
                            <li>Monitor student welfare issues alongside President</li>
                            <li>Coordinate with committee members as needed</li>
                        </ul>
                    </div>
                </div>
            </div>

...
try {
    ...
    // Get overall attendance statistics for all committee members (for VP oversight)
    $overall_attendance_stmt = $pdo->query("
        SELECT 
            COUNT(*) as total_meetings,
            AVG(present_count * 100.0 / total_attendees) as avg_attendance_rate
        FROM (
            SELECT 
                m.id,
            ...
            WHERE m.meeting_date >= DATE_SUB(CURDATE(), INTERVAL 3 MONTH)
            GROUP BY m.id
        ) as meeting_stats
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header">
                <h1 class="page-title">Guild Council Meetings 👨‍💼</h1>
                <p class="page-description">View all guild council committee meetings and track attendance records</p>
            </div>

            <!-- Info Alert -->
            <div class="alert alert-info">
                <i class="fas fa-info-circle"></i> 
                <strong>Note:</strong> As Vice President of Representative Board, you can view all guild council meetings 
                and monitor attendance across all committees.
            </div>

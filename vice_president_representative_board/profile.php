...
<head>
    ...
    <title>Profile & Settings - Vice President Representative Board - Isonga RPSU</title>
            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-role">Vice President - Representative Board</div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="profile-tab" class="tab-pane <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                                <form method="POST" id="profileForm">
                                    ...
                                    <div class="form-section">
                                        <h4>Representative Board Portfolio</h4>
                                        <div class="form-group">
                                            <label for="bio">Bio & Role Description</label>
                                            <textarea id="bio" name="bio" class="form-control" 
                                                      placeholder="Describe your role as Vice President of Representative Board and your initiatives..."><?php echo htmlspecialchars($user['bio'] ?? ''); ?></textarea>
                                        </div>
                                ...
                                <form method="POST" id="preferencesForm">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive class representative updates and executive committee notifications via email</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive urgent student issues and meeting alerts via SMS</small>
                                        </div>
                                    </div>

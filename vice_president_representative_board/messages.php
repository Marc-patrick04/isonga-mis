...
<head>
    ...
    <title>Messages - vice_president_representative_board - Isonga RPSU</title>
        ...
        <div class="nav-container">
            <div class="logo-section">
                ...
                <div class="brand-text">
                    <h1>Isonga - vice_president_representative_board</h1>
                </div>
            </div>
            <div class="user-menu">
                ...
                <div class="user-info">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-role">vice_president_representative_board</div>
                    </div>
                </div>

...
try {
    // Sports teams count
    $stmt = $pdo->query("SELECT COUNT(*) as sports_teams FROM sports_teams WHERE status = 'active'");
    $sports_teams = $stmt->fetch(PDO::FETCH_ASSOC)['sports_teams'];
    
    // Upcoming competitions
    $stmt = $pdo->query("SELECT COUNT(*) as upcoming_competitions FROM sports_competitions WHERE status = 'upcoming'");
    $upcoming_competitions = $stmt->fetch(PDO::FETCH_ASSOC)['upcoming_competitions'];
    
    // Active training sessions
    $stmt = $pdo->query("SELECT COUNT(*) as training_sessions FROM training_sessions WHERE status = 'scheduled'");
    $training_sessions = $stmt->fetch(PDO::FETCH_ASSOC)['training_sessions'];
    ...
    $sports_teams = $upcoming_competitions = $training_sessions = $unread_messages = 0;
...
<head>
    ...
    <title>Profile & Settings - Minister of Sports - Isonga RPSU</title>
            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-role">Minister of Sports</div>
                        
                        <div class="profile-stats">
                            <div class="stat-item">
                                <div class="stat-number"><?php echo $sports_teams; ?></div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="bio" name="bio" class="form-control" 
                                                      placeholder="Tell us about yourself and your sports initiatives..."><?php echo htmlspecialchars($user['bio'] ?? ''); ?></textarea>
                                        </div>

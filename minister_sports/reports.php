...
<head>
    ...
    <style>
        :root {
            ...
            --sports-secondary: #34D399;
            --sports-accent: #059669;
            --sports-light: #ECFDF5;
            --gradient-primary: linear-gradient(135deg, var(--sports-primary) 0%, var(--sports-accent) 100%);
        ...
        * {
        ...
        .menu-item a:hover, .menu-item a.active {
            ...
            border-left-color: var(--sports-primary);
            color: var(--sports-primary);
        }
        ...
        .stat-card {
            ...
            box-shadow: var(--shadow-sm);
            border-left: 3px solid var(--sports-primary);
            transition: var(--transition);
            display: flex;
            align-items: center;
            gap: 1rem;
        ...
        <main class="main-content">
            <div class="dashboard-header">
                <div class="welcome-section">
                    ...
                    <p>Create, manage, and export sports reports using templates</p>
                </div>
            </div>

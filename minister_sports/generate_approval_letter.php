...
try {
    ...
    $pdf->SetTitle('Sports & Entertainment Budget Approval Letter');
    ...
    $pdf->Cell(0, 10, 'SPORTS & ENTERTAINMENT BUDGET PROGRAM', 0, 1, 'C');
    $pdf->SetFont('helvetica', 'B', 16);
    ...
    $pdf->Cell(0, 10, 'Ref: RPSU/MC/SEBP/' . date('Y') . '/' . str_pad($request_id, 4, '0', STR_PAD_LEFT), 0, 1, 'R');
    ...
    // Introduction
    $intro = "I, " . $request['requester_name'] . ", serving as Minister of Sports & Entertainment at RP Musanze College, hereby strongly prove that I requested a budget of RWF " . 
    ...
    $purpose = "This letter serves as official evidence and reference for the sports & entertainment budget approved to support: " . 
        $request['purpose'] . ". The funds will be utilized for the intended sports and entertainment activities as stated in the application.\n\n";
    ...
    $pdf->Cell(0, 10, 'GUIDELINES FOR BUDGET UTILIZATION:', 0, 1, 'L', true);
    $pdf->Ln(3);

    $pdf->SetFont('helvetica', '', 11);
    $guidelines = "1. The approved amount MUST be used exclusively for: " . $request['purpose'] . "\n" .
        "2. Funds allocated for sports equipment, team development, tournaments, and entertainment activities\n" .
        "3. Keep all original receipts and invoices for verification purposes\n" .
        ...
        "8. Submit a detailed expenditure report within 30 days after fund utilization\n" .
        "9. This approval is non-transferable to any other committee\n" .
        "10. Maintain proper financial records for audit purposes\n\n";
    ...
    $disbursement = "To receive the approved budget, you MUST present this printed letter at the Guild Council Office along with:\n\n" .
        "✓ Original Student ID Card\n" .
        "✓ Printed copy of this approval letter\n" .
        "✓ Completed disbursement form (available at the office)\n" .
        "✓ Detailed implementation plan for sports/entertainment activities\n\n" .
    ...
    $agreement = "I hereby declare that I have read and understood all the terms and conditions stated above. " .
        "I agree to use the approved budget responsibly and exclusively for sports and entertainment activities. " .
        "I acknowledge that any violation of these terms may result in disciplinary action and requirement to repay misused funds.\n";
    ...
    <tr>
        ...
        <td width="50%" class="signature-cell">
            ...
            <div style="margin-bottom: 8px; font-size: 11px;">
                Position: Minister of Sports & Entertainment
            </div>
            <div style="margin-bottom: 8px; font-size: 11px;">
    ...
    $pdf->SetTextColor(128, 128, 128); // Gray color
    $pdf->MultiCell(0, 8, 
        "Note: This document serves as official approval for sports & entertainment budget disbursement. " .
    ...
    // Output PDF
    $filename = 'Sports_Budget_Approval_' . ($request['requester_reg'] ?: 'Minister') . '_' . date('Ymd') . '.pdf';

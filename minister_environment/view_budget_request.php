...
<head>
    ...
    <title>View Budget Request - Minister of Environment & Security - Isonga RPSU</title>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="page-title">
                ...
                <p>View detailed information about your environment & security funding request</p>
            </div>
        </div>
                ...
                <div class="info-grid">
                    ...
                    <div>
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value">Minister of Environment & Security</div>
                        </div>
                        <div class="info-group">
            ...
            <div class="card-body">
                <div class="timeline">
                    ...
                    <div class="timeline-item completed">
                        ...
                        <div class="timeline-content">Environment & Security budget request was submitted for review</div>
                    </div>
                    ...
                    <div class="timeline-item <?php echo $request['status'] === 'funded' ? 'completed' : 'pending'; ?>">
                        ...
                        <div class="timeline-content">
                            <?php if ($request['status'] === 'funded'): ?>
                                Funds have been disbursed for environment & security initiatives
                            <?php else: ?>
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ol style="margin: 0.5rem 0 0 1rem;">
                        ...
                        <li>Print the letter and get physical signatures from both Minister of Environment & Security and Vice Guild Finance</li>

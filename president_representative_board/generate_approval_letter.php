...
try {
    ...
    $pdf->SetTitle('President Representative Board Budget Approval Letter');
    ...
    $pdf->SetTextColor(128, 0, 128); // Purple color for leadership
    $pdf->Cell(0, 10, 'PRESIDENT REPRESENTATIVE BOARD PROGRAM', 0, 1, 'C');
    $pdf->SetFont('helvetica', 'B', 16);
    ...
    $pdf->Cell(0, 10, 'Ref: RPSU/MC/PRBP/' . date('Y') . '/' . str_pad($request_id, 4, '0', STR_PAD_LEFT), 0, 1, 'R');
    ...
    // Introduction
    $intro = "I, " . $request['requester_name'] . ", serving as President of Representative Board at RP Musanze College, hereby strongly prove that I requested a budget of RWF " . 
    ...
    $purpose = "This letter serves as official evidence and reference for the President Representative Board budget approved to support: " . 
        $request['purpose'] . ". The funds will be utilized for student representation, leadership activities, " .
        "and board operations as stated in the application.\n\n";
    ...
    $pdf->Cell(0, 10, 'GUIDELINES FOR REPRESENTATIVE BOARD BUDGET UTILIZATION:', 0, 1, 'L', true);
    $pdf->Ln(3);

    $pdf->SetFont('helvetica', '', 11);
    $guidelines = "1. The approved amount MUST be used exclusively for: " . $request['purpose'] . "\n" .
        "2. Funds allocated for student representation, leadership development, and board operations\n" .
        "3. Budget must support activities that benefit the entire student body\n" .
        ...
        "9. Submit detailed expenditure report with impact assessment within 30 days\n" .
    ...
    $pdf->SetFont('helvetica', 'B', 12);
    $pdf->SetFillColor(128, 0, 128); // Purple background for leadership
    ...
    $disbursement = "To receive the approved Representative Board budget, you MUST present this printed letter at the Guild Council Office along with:\n\n" .
        "✓ Original Student ID Card\n" .
        "✓ Printed copy of this approval letter\n" .
        "✓ Completed disbursement form (available at the office)\n" .
        "✓ Detailed Representative Board activity implementation plan\n" .
        "✓ Student representation impact assessment plan\n\n" .
    ...
    // Agreement Section
    $pdf->SetFont('helvetica', 'B', 12);
    $pdf->Cell(0, 10, 'PRESIDENT DECLARATION AND AGREEMENT:', 0, 1);
    $pdf->SetFont('helvetica', '', 11);

    $agreement = "I hereby declare that I have read and understood all the terms and conditions stated above. " .
        "As President of Representative Board, I agree to use the approved budget responsibly for student " .
        "representation and leadership activities that benefit the entire student body. I acknowledge that " .
    ...
    <tr>
        ...
        <!-- RIGHT CELL: PRESIDENT ACKNOWLEDGEMENT -->
        <td width="50%" class="signature-cell">
            <div class="signature-header">PRESIDENT ACKNOWLEDGEMENT</div>
            <div style="margin-bottom: 10px; font-size: 11px;">
            ...
            <div style="margin-bottom: 8px; font-size: 11px;">
                Position: President of Representative Board
            </div>
            <div style="margin-bottom: 8px; font-size: 11px;">
    ...
    $pdf->Cell(0, 10, 'LEADERSHIP ACCOUNTABILITY DECLARATION', 0, 1, 'C', true);
    $pdf->SetFont('helvetica', '', 10);
    $pdf->Ln(3);
    
    $accountability_text = "As President of Representative Board, I commit to:\n" .
        "✓ Transparent utilization of funds for student benefit\n" .
        "✓ Regular reporting to the student body on budget utilization\n" .
        "✓ Upholding the highest standards of financial integrity\n" .
        "✓ Ensuring activities align with student needs and interests\n" .
        "✓ Promoting inclusive student representation\n\n" .
    ...
    $pdf->SetTextColor(128, 128, 128); // Gray color
    $pdf->MultiCell(0, 8, 
        "Note: This document serves as official approval for President Representative Board budget disbursement. " .
        "Any alterations to this document render it invalid. As a student leader, you are accountable to " .
        "the student body for transparent and responsible use of these funds.\n\n" .
    ...
    $pdf->Text(15, 150, 'LEADERSHIP');
    $pdf->Text(15, 230, 'ACCOUNTABILITY');
    $pdf->SetAlpha(1);

    // Output PDF
    $filename = 'President_Board_Budget_Approval_' . ($request['requester_reg'] ?: 'President_RB') . '_' . date('Ymd') . '.pdf';

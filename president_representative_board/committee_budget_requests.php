        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-title">
                    ...
                    <p>Request budget for Representative Board activities and track funding status</p>
                </div>
            ...
            <form method="POST" enctype="multipart/form-data" id="budgetRequestForm">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="request_title" placeholder="e.g., Representative Board Training Workshop" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="purpose" rows="4" placeholder="Describe the purpose of this funding and how it will be used for Representative Board activities..." required></textarea>
                    </div>

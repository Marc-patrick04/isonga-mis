...
try {
    $stmt = $pdo->prepare("SELECT id FROM committee_members WHERE user_id = ? AND role = 'president_representative_board' AND status = 'active'");
    $stmt->execute([$user_id]);
...
// Build query for meetings list - President of Representative Board can see all meetings
$query = "
...
try {
    ...
    // Get upcoming important meetings (next 7 days) - focus on representative board meetings
    $stmt = $pdo->prepare("
        SELECT m.*, cm.name as chairperson_name
        FROM meetings m
        LEFT JOIN committee_members cm ON m.chairperson_id = cm.user_id
    ...
    // Get class representatives attendance statistics
    $stmt = $pdo->prepare("
        SELECT 
            COUNT(DISTINCT cm.id) as total_reps,
            COUNT(DISTINCT ma.committee_member_id) as reps_with_attendance,
    ...
    $total_meetings = $upcoming_meetings = $todays_meetings = $rep_board_meetings = 0;
    $attendance_rate = 0;
    $attendance_stats = ['total_invited' => 0, 'attended' => 0, 'absent' => 0, 'excused' => 0];
    $meeting_types = [];
    $upcoming_important = [];
...
<head>
    ...
    <title>Meetings - President of Representative Board - Isonga RPSU</title>
        ...
        <div class="nav-container">
            <div class="logo-section">
                ...
                <div class="brand-text">
                    <h1>Isonga - President of Representative Board</h1>
                </div>
            </div>
            <div class="user-menu">
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <p class="page-description">Monitor all meetings and track attendance for oversight purposes</p>
            </div>

            <!-- Info Alert -->
            <div class="alert alert-info">
                <i class="fas fa-info-circle"></i> 
                <strong>Oversight Role:</strong> As President of Representative Board, you can view all meetings and monitor attendance patterns across committees for effective oversight.
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card info">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-label">Representative Board Meetings</div>
                    </div>
                </div>
            ...
            <div class="stats-grid" style="margin-top: 1rem;">
                ...
                <div class="stat-card success">
                    ...
                    <div class="stat-content">
                        <div class="stat-number"><?php echo round($reps_attendance_stats['avg_attendance_rate'] * 100); ?>%</div>
                        <div class="stat-label">Avg Rep Attendance</div>
                    </div>
                </div>
                <div class="stat-card info">
                    <div class="stat-icon">
            ...
            <div class="content-grid">
                ...
                <div class="right-column">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Representatives Overview</h3>
                        </div>
                        <div class="card-body">
                            <div style="display: grid; gap: 1rem;">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Total Representatives</span>
                                    <strong style="color: var(--text-dark);"><?php echo $reps_attendance_stats['total_reps']; ?></strong>
                                </div>
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Active in Meetings</span>
                                    <strong style="color: var(--success);"><?php echo $reps_attendance_stats['reps_with_attendance']; ?></strong>
                                </div>
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: var(--dark-gray); font-size: 0.8rem;">Average Attendance</span>
                                    <strong style="color: var(--primary-blue);"><?php echo round($reps_attendance_stats['avg_attendance_rate'] * 100); ?>%</strong>
                                </div>
                            </div>
                            <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid var(--medium-gray);">
                                <a href="class_reps.php" class="filter-btn" style="width: 100%; text-align: center; display: block;">

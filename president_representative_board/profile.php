...
try {
    ...
    // Upcoming class representative meetings
    ...
    $total_reps = $pending_reports = $upcoming_meetings = $unread_messages = 0;
...
<head>
    ...
    <title>Profile & Settings - President of Representative Board - Isonga RPSU</title>
            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-role">President - Representative Board</div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="profile-tab" class="tab-pane <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                                <form method="POST" id="profileForm">
                                    ...
                                    <div class="form-section">
                                        <h4>Representative Board Information</h4>
                                        <div class="form-group">
                                            <label for="bio">Bio & Leadership Statement</label>
                                            <textarea id="bio" name="bio" class="form-control" 
                                                      placeholder="Tell us about your leadership approach and vision for the representative board..."><?php echo htmlspecialchars($user['bio'] ?? ''); ?></textarea>
                                        </div>
                                ...
                                <form method="POST" id="preferencesForm">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive class representative reports and meeting notifications via email</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-hint">Receive urgent representative alerts via SMS</small>
                                        </div>
                                    </div>
